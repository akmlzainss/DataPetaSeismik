    ...
    <nav class="navbar">
        <div class="navbar-container">
            ...
            <ul class="navbar-menu" id="navbarMenu">
                ...
                <li>
                    <a href="#" class="{{ Request::routeIs('tentang') ? 'active' : '' }}">
                        Tentang
                    </a>
                </li>
                <li>
                ...
                <div class="footer-section footer-about">
                    <div class="footer-logo">
                        ...
                        <div class="footer-logo-text">
                            <span class="main">BBSPGL</span>
                            <span class="sub">Kementerian ESDM</span>
                        </div>
                    </div>
                    <p>Balai Besar Survei dan Pemetaan Geologi adalah unit pelaksana teknis yang bertanggung jawab dalam survei dan pemetaan geologi Indonesia untuk mendukung pengembangan sumber daya mineral nasional.</p>
