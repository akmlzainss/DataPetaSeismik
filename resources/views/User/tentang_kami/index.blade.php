...
@section('content')
    ...
    <div class="page-hero">
        <div class="container-custom">
            ...
            <p class="hero-subtitle">Profil, Visi Misi, dan Struktur Organisasi Balai Besar Survei dan Pemetaan Geologi
                Kelautan</p>
        </div>
    </div>
            ...
            <div class="tentang-content">
                ...
                <div class="content-section">
                    ...
                    <div class="struktur-box">
                        ...
                        <img src="{{ asset('storage/struktur_organisasi.png') }}" alt="Struktur Organisasi BBSPGL"
