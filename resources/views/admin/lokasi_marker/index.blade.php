...
<div class="info-card">
    ...
    <div id="tab-dropdown" class="tab-content active">
        <div class="tab-section">
            ...
            <div class="alert-box alert-info">
                ...
                <div>
                    <strong>Cara Penggunaan:</strong> Pilih survei dari dropdown → Peta akan menampilkan marker preview (orange) → Klik tombol "Terapkan Marker Otomatis" untuk menyimpan permanen
                </div>
            </div>
            ...
            <div class="helper-box">
                ...
                Sistem akan mencari koordinat otomatis berdasarkan nama wilayah survei. Marker preview berwarna orange akan muncul di peta sebelum Anda menyimpannya secara permanen.
            </div>
        </div>
    </div>
    ...
    <div id="tab-manual" class="tab-content">
        <div class="tab-section">
            ...
            <div class="alert-box alert-warning">
                ...
                <div>
                    <strong>Petunjuk:</strong> Pilih survei → Isi koordinat manual atau klik di peta → Klik tombol "Simpan Marker Manual Permanen"
                </div>
            </div>
            ...
            <div class="form-card">
                ...
                <div class="manual-input-grid">
                    ...
                    <div>
                        ...
                        <input type="text" id="manualLat" class="form-input" 
                            placeholder="-6.2088">
                    </div>
                    <div>
                        <label class="form-label required-field">Bujur (Longitude)</label>
                        <input type="text" id="manualLng" class="form-input" 
    ...
    <div class="info-box">
        ...
        <ul>
            <li><strong>Tab Auto Geocoding:</strong> Pilih survei dari dropdown, sistem akan mencari koordinat otomatis berdasarkan wilayah, lalu klik tombol "Terapkan Marker Otomatis" untuk menyimpan</li>
            <li><strong>Tab Input Manual:</strong> Pilih survei, isi koordinat manual atau klik di peta, lalu klik tombol "Simpan Marker Manual Permanen"</li>
            <li><strong>Marker Preview:</strong> Marker berwarna orange adalah preview sementara yang belum tersimpan</li>
            <li><strong>Marker Permanen:</strong> Marker berwarna biru adalah marker yang sudah tersimpan dan tidak dapat dipindahkan</li>
            <li><strong>Menghapus Marker:</strong> Klik kanan pada marker permanen (biru) untuk menghapusnya dari peta</li>
            <li><strong>Batasan Peta:</strong> Peta dibatasi hanya menampilkan wilayah Indonesia (zoom minimum level 5)</li>
        </ul>
    </div>
</div>
@endsection
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    autoApplyBtn?.addEventListener('click', async function() {
        ...
        .then(data => {
            if (data.success) {
                ...
                const manualOption = manualSurveiSelect.querySelector(`option[value="${surveiId}"]`);
    ...
    function showManualPreview() {
        ...
        const tempManualMarker = L.marker(latlng, { manualPreview: true, icon: orangeIcon }).addTo(map);
    ...
    saveManualBtn?.addEventListener('click', async function() {
        ...
        .then(data => {
            if (data.success) {
                ...
                const autoOption = surveiSelect.querySelector(`option[value="${surveiId}"]`);
