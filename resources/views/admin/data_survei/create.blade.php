                ...
                <div class="form-grid">
                    ...
                    <div class="form-group">
                        ...
                        <select name="tipe" class="form-select" required>
                            ...
                            <option value="2D" {{ old('tipe') == '2D' ? 'selected' : '' }}>2D
                            </option>
                            <option value="3D" {{ old('tipe') == '3D' ? 'selected' : '' }}>3D
                            </option>
                            <option value="HR" {{ old('tipe') == 'HR' ? 'selected' : '' }}>HR
                            </option>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="tahun" class="form-input" value="{{ old('tahun', date('Y')) }}"
                            min="1950" max="{{ date('Y') + 5 }}" required>
                        @error('tahun')
                            <span class="error-message">{{ $message }}</span>
                        @enderror
                    ...
                    <div class="form-group full-width">
                        ...
                        <textarea name="deskripsi" class="form-textarea" placeholder="Jelaskan secara singkat tentang survei ini..."
                            id="deskripsi-editor">{{ old('deskripsi') }}</textarea>
                        @error('deskripsi')
                            <span class="error-message">{{ $message }}</span>
                        @enderror
                    ...
                    <div class="form-group full-width">
                        ...
                        <input type="file"                            name="gambar_pratinjau" class="form-file"
                        ...
                        <span class="help-text">Format: JPG, PNG, TIFF • Maksimal
