{{-- resources/views/pegawai/auth/reset-password.blade.php --}}
<!DOCTYPE html>
<html lang="id">
            ...
            <div class="login-right">
                <div class="login-form-container">
                    <div class="login-header">
                        ...
                        <p>Masukkan password baru untuk akun Pegawai ESDM Anda</p>
                    </div>
                    ...
                    <form method="POST" action="{{ route('pegawai.password.update.reset') }}" class="login-form">
                        @csrf
