{{-- resources/views/pegawai/auth/forgot-password.blade.php --}}
<!DOCTYPE html>
<html lang="id">
...
<head>
    ...
    <title>Lupa Password Pegawai - BBSPGL</title>
            ...
            <div class="login-right">
                <div class="login-form-container">
                    <div class="login-header">
                        <h2>Lupa Password?</h2>
                        <p>Masukkan email ESDM Anda untuk menerima link reset password</p>
                    </div>
                    ...
                    <form method="POST" action="{{ route('pegawai.password.email') }}" class="login-form">
                        @csrf
